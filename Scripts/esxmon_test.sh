...
sleeptime=30
corecount="$(sshpass -f ~/password ssh -t root@192.168.1.24 "grep -c ^processor /proc/cpuinfo")"
...
do
        ...
        cpu7=`snmpget -v 2c -c public 192.168.1.24 HOST-RESOURCES-MIB::hrProcessorLoad.7 -Ov`
